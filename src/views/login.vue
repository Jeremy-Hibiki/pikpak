    ...
    <div class="login">
      ...
      <div class="login-box">
        <n-form label-align="left" label-placement="left" label-width="0" class="login-form">
          ...
          <n-form-item label="">
            <n-checkbox v-model:checked="remember" @update:checked="showMessage"
              >记住登陆</n-checkbox
            >
          </n-form-item>
          <n-form-item>
            <n-button type="primary" class="block" :loading="loading" @click="loginPost"
              >登陆</n-button
            >
          </n-form-item>
          <n-form-item label="">
            <a
              target="_blank"
              href="https://i.mypikpak.com/v1/file/center/account/v1/password/?type=forget_password&locale=zh-cn"
...
const getApk = () => {
  http.get('https://api-drive.mypikpak.com/package/v1/apk/url/225815').then((res: any) => {
