          ...
          <template #default>
            <n-space inline>
              <n-input
                type="text"
                size="small"
                :value="'https://toapp.mypikpak.com/activity/invited?code=' + invitationCode"
              ></n-input>
              <n-button
                size="small"
                type="primary"
                @click="copy('https://toapp.mypikpak.com/activity/invited?code=' + invitationCode)"
                >复制</n-button
              >
            </n-space>
...
import { Accessible, ArrowDownCircle, Copyright, Diamond } from '@vicons/tabler';
...
const getInviteCode = async () => {
  http.get('https://api-drive.mypikpak.com/vip/v1/activity/inviteCode').then((res: any) => {
...
const queryUserInvitationInfo = async () => {
  http
    .get('https://api-drive.mypikpak.com/vip/v1/activity/inviteInfo')
    .then((res) => {
...
const getChaApkDownloadLink = () => {
  http
    .get(`https://api-drive.mypikpak.com/package/v1/apk/url/${invitationCode.value}`)
    .then((res: any) => {
